...
class Address
{
   ...
   public:
      ...
      Address();
      Address(string hm, string str, string ap, string ci, string sta, string zi);
      ...
      void output() const;
      friend  ostream& operator << (ostream& out, const Address& place);
      friend  istream& operator >> (istream& in, Address& place);
      //for saving
      friend  ofstream& operator << (ofstream& out, Address& place);
